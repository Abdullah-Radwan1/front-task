                    ...
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-accent font-semibold">${item.product.price}</p>
                        ...
                        <Button variant="ghost" size="icon" className="h-6 w-6 self-start" onClick={() => removeItem(item.product.id)}>
                          <X className="h-3 w-3" />
                        </Button>
                      </motion.div>
                    ))}
