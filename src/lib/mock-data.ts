...
export const products: Product[] = [
  {
    ...
    nameAr: "كرونوجراف إليت",
    description: "Swiss-made chronograph with sapphire crystal",
    descriptionAr: "كرونوجراف سويسري الصنع مع كريستال الياقوت الأزرق",
    price: 2499,
    category: "watches",
  ...
  },
  {
    ...
    descriptionAr: "مقاوم للماء حتى 300 متر مع إطار سيراميك",
    price: 1899,
    category: "watches",
  ...
  },
  {
    ...
    descriptionAr: "جلد إيطالي كامل الحبة مع أجهزة زنكية",
    price: 890,
    category: "leather",
  ...
  },
  {
    id: "4",
    name: "Voyager Duffle",
    nameAr: "حقيبة المسافر",
    description: "Hand-stitched travel bag in vegetable-tanned leather",
    descriptionAr: "حقيبة سفر مخيطة يدويًا من الجلد المدبوغ بالنبات",
    price: 1250,
    category: "leather",
  ...
  },
  {
    id: "5",
    name: "Onyx Cufflinks",
    nameAr: "أزرار جزع الأسود",
    description: "Sterling silver cufflinks with black onyx stones",
    descriptionAr: "أزرار أكمام من الفضة الإسترليني مع أحجار جزع أسود",
    price: 320,
  ...
  },
  {
    ...
    nameAr: "قلادة سلسلة ذهبية",
    description: "18K gold-plated Cuban link chain",
    descriptionAr: "سلسلة حلقات كوبية مطلية بالذهب عيار 18",
    price: 450,
    category: "jewelry",
  ...
  },
  {
    ...
    descriptionAr: "خاتم ختم من الفضة الإسترليني محفور يدويًا",
    price: 280,
    category: "jewelry",
  ...
  },
  {
    ...
    nameAr: "نظارات الطيار",
    description: "Titanium frame with polarized lenses",
    descriptionAr: "إطار من التيتانيوم مع عدسات مستقطبة",
    price: 395,
    category: "accessories",
  ...
  },
  {
    ...
    nameAr: "ساعة فستان رفيعة",
    description: "Ultra-thin automatic movement, rose gold case",
    descriptionAr: "حركة أوتوماتيكية رفيعة جدًا، علبة ذهب وردي",
    price: 3200,
    category: "watches",
  ...
  },
  {
    ...
    nameAr: "حامل بطاقات من الجلد",
    description: "Minimalist card holder in saffiano leather",
    descriptionAr: "حامل بطاقات بسيط من جلد سافيانو",
    price: 145,
    category: "leather",
  ...
  },
  {
    ...
    descriptionAr: "حرير إيطالي مجدول يدويًا بنمط باسليق",
    price: 85,
    category: "accessories",
  ...
  },
  {
    ...
    descriptionAr: "ماس مزروع في المختبر بعيار 0.5 قيراط في إطار بلاتيني",
    price: 1800,
    category: "jewelry",
